...
| #   | ルール名       | カテゴリ   | 特記事項                     |
| --- | -------------- | ---------- | ---------------------------- |
| 1   | 都落ち         | 終了後     | 前回大富豪が1位でなければ大貧民 |
| 2   | 下剋上         | 終了後     | 前回大貧民が1位なら全員ランクリセット |
| 3   | ラッキーセブン | 特殊       | 7x3で場が流れると勝利        |
| 4   | 天変地異       | 交換       | 貧民/大貧民が10以下のみなら交換免除 |
| 5   | サルベージ     | 回収       | 3で場が流れた時に捨て札から1枚回収 |
| 6   | 次期エース     | 親権       | Aで場が流れた時に親になる    |
| 7   | サタン         | 回収       | 6x3で捨て札から1枚回収       |
| 8   | 栗拾い         | 回収       | 9を出すと枚数分捨て札から回収 |
| 9   | 銀河鉄道999    | 回収       | 9x3で手札2枚捨て、捨て札から2枚引く |
